...
authenticator = IAMAuthenticator('oxRMU9x_RDw6z9XpXBUDn9Q0yCLl_iNGBHv_rNwIW5cl')
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url('https://api.us-east.text-to-speech.watson.cloud.ibm.com/instances/b53a7cce-2456-4cc0-9b9f-fb19f77b34a4')
...
def get_url():
    ...
    return ("wss://{}/speech-to-text/api/v1/recognize"
           "?model=en-GB_BroadbandModel").format(host)
